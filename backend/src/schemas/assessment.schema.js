...
const business = z.object({ type: z.string().optional(), status: z.string().optional(), project_cost: optionalNumber, loan_required: optionalNumber, own_contribution: optionalNumber, existing_loans: z.boolean().optional(), outstanding_loan: optionalNumber, description: z.string().optional() }).default({})

export const assessmentSchema = z.object({ corporation: z.enum(CORPORATIONS), profile, requirement, business, group, education, nskfdc }).superRefine((value, context) => {
